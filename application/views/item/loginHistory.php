<?php
$log = ($itemsInfo)?$itemsInfo->item_log:'';
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?= !empty($itemsInfo) ? $itemsInfo->item_code : "Item" ?></h3>
                    <div class="box-tools">
                    </div>
                </div><!-- /.box-header -->
                  ...
                  <table class="table table-hover">
                    ...
                    if(!empty($log))
                    {
                      foreach($log as $record){
                        ...
                        $row = $query->row(); ?>
                        <tr>
                          <td><?php echo (isset($row->name))?$row->name:'User Deleted'; ?></td>
                          <td><?php echo (isset($record->ip))?$record->ip:'No IP'; ?></td>
